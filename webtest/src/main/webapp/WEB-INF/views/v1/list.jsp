...
<body>
    <div class="container mt-3">
        ...
        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
            ...
            <a href="/v1/list?type=1" class="btn btn-success">승인</a>
            <a href="/v1/list?type=0" class="btn btn-warning">미승인</a>
            <a href="/v1/new" class="btn btn-primary">추가</a>
        </div>
        <div class="list-group mt-2 text-center">
            <c:forEach var="row" items="${list}" varStatus="status">
            	<a class="list-group-item m-1 ${(row.accept)? 'bg-success' : 'bg-warning'} display-6" href="/v1/detail?no=${row.no}">${row.title}</a>
            </c:forEach>
